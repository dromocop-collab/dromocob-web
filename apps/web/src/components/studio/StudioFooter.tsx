    ...
    <footer className={s.footer}>
      ...
      <div className={s.footerInner}>
        ...
        <div className={s.footerGrid}>
          ...
          <div><b>Keşfet</b><Link href="/#tasarimlar">Tüm tasarımlar</Link><Link href="/sektorler">Sektörler</Link><Link href="/mobil-uygulama-gelistirme">Mobil uygulamalar</Link><Link href="/hakkimizda">Stüdyo</Link></div>
