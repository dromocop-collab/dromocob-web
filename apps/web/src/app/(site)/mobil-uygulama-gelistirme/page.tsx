...
export default function MobileAppDevelopmentPage() {
  return <main className={s.page}>
    ...
    <section className={s.cta}><div><span><Sparkles/> ÜRÜNÜNÜZÜ BİRLİKTE TASARLAYALIM</span><h2>iOS ve Android&apos;de güçlü bir başlangıç.</h2></div><ProjectStartButton label="Proje kapsamını oluştur" variant="light" mode="mobile"/></section>
  </main>;
}
