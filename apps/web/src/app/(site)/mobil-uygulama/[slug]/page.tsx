...
export default function MobileAppDetail({params}:{params:{slug:string}}){
  ...
  return <main className={s.page} style={{"--accent":app.accent} as React.CSSProperties}>
    ...
    <section className={s.cta}><div><span><Sparkles/> SİZE ÖZEL MOBİL ÜRÜN</span><h2>{app.name} deneyimini markanıza taşıyalım.</h2></div><ProjectStartButton label="Uygulama projesi başlat" variant="light"/></section>
  </main>;
}
